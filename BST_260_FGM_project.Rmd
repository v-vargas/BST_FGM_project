...
Additionally, the methods that we planned to replicate included both females born in countries that practice FGM and their daughters. We were not able to find a usable data on these female's daughters and believe that the methods used in the paper might be incorrect. We settled on doing a more conservative and valid estimate of FGM by just including females born in the countries that practice FGM, and excluding daughters. We were able to find a variable in the ACS dataset that was "presence of daughter in the household", but does not specify the number of daughters. We believe this is the indicator the authors may have used that could have resulted in an incorrect estimate and have contacted the authors for further clarification.  
...
To obtain the estimate the number of females living in the US who had experienced FGM, we created a new variable that was the multiplication of the country FGM estimate and the number of females born in that country, currently living in the US. When doing our analysis using the first method described, we calculated a prevalence of 370,055. The paper mentioned previously found an estimate of 545,000. It makes sense that our estimate is less than the estimate in the paper as we did not include daughters at risk in our estimate due to data constraints and concerns regarding assumptions the authors made. 
