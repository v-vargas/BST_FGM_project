...
To obtain the estimate the number of women living in the US who had experienced FGM, we created a new variable that was the multiplication of the country FGM estimate and the number of women born in that country, currently living in the US. The paper mentioned previosuly found an estimate of 545,000. When doing our analysis using the first method, we calculated a prevalence of 370,055. Our estimate is smaller than the paper we have cited. This could be both because less women are migrating to the US from these countreis and the prevalence of FGM in these countries are also decreasing. 
